...
var reply = (teks) => {
KirBotz.sendMessage(from, teks, text, { thumbnail: kirrfoto, sendEphemeral: true, quoted: krtd1, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `OWNER`,body:"SELECT",previewType:"PHOTO",thumbnail:kirrfoto,sourceUrl:`https://wa.me/qr/SJFA2RHAJWE7P1`}}})
}
...
await KirBotz.setStatus(`I'm KirBotz 🤖 | ${uptimer} ⏰ | Status : ${status} ⚙️ | ${autoregis.length} User 👤`).catch((_) => _);
...
var bio = `*────" 𝖀𝖘𝖊𝖗 𝕴𝖓𝖋𝖔 "────*
    *ΝᎪᎷᎬ :* ${pushname}
    *ᏴᏆϴ :* ${thu.status}
    *ᏢᎡᎬᎷᏆႮᎷ:* ${isPremium ? 'I͎y͎a͎' : 'T͎i͎d͎a͎k͎'}
    *ᏢᎬΝᏀᏀႮΝᎪ ᎪͲՏᎪᏆᎡ ᏴϴͲᏃ:* ${autoregis.length} 𝐔𝐬𝐞𝐫
*────────────────*`
...
*↻𝗕𝗶𝗼 𝗨𝘀𝗲𝗿* : ${thu.status}
*↻𝗣𝗿𝗲𝗺𝗶𝘂𝗺:* ${isPremium ? 'I͎y͎a͎' : 'T͎i͎d͎a͎k͎'}
...
*↻𝗠𝗼𝗱𝗲 𝗕𝗼𝘁* : ${KirSelfPublic ? 'S̶E̶L̶F̶' : 'P̶U̶B̶L̶I̶C̶'}
